require.config({
  paths: {
    'jquery': ['../bower_components/jquery/dist/jquery', 'http://ajax.googleapis.com/ajax/libs/jquery/1.4.4/jquery.min'],
    'backbone': ['../bower_components/backbone/backbone'],
    'underscore': ['../bower_components/underscore/underscore-min'],
    'text': ['../bower_components/text/text'],
    'mustache': ['../bower_components/mustache/mustache'],
    'bootstrap': ['../bower_components/dist/js/bootstrap.min.js', 'https://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/js/bootstrap.min.js'],
